      ...
      <div className="w-full flex flex-row bg-bg-default justify-between items-center">
        ...
        <div className="p-1">
          <label className="inline-flex items-center cursor-pointer" title="dark/light">
            ...
            <div
              className="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 rounded-full peer dark:bg-bg-accentEmphasis peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border after:rounded-full after:h-4 after:w-4 after:transition-all  peer-checked:bg-black"
            ></div>
          </label>
        </div>
      </div>
